...
def search_in_file(file_path, pattern, context_before=500, context_after=2000, start_index=0):
...
# Search for usage of wi (VueFlow) in the template part (usually near the end of setup)
search_in_file(path, 'v(wi', start_index=700000)
search_in_file(path, 'v(wi', start_index=1000000) # Maybe it's further down
